...
type Team = { next: { opp: string; home: boolean; implied: number; total: number; spread: number } | null; offense: { prev: Off | null; cur: Off | null }; defense: { prev: Def | null; cur: Def | null }; roles: { prev: Role[]; cur: Role[] } }
